...
const S = {
  ...
  SECTION_A_NOTICE:     'section-a-notice',
  SECTION_A:            'section-a',
...
export default function App() {
  ...
  switch (screen) {
    ...
    case S.SECTION_A_NOTICE:
      return (
        <div className="flex flex-col min-h-screen bg-white">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100">
            <button
              onClick={() => setScreen(aReturnScreen)}
              aria-label="Go back"
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-10">
            ...
            <p className="text-gray-600 text-base text-center leading-relaxed mb-8 px-2">
              The information in this section should be for the <strong className="text-black">person the passport is for</strong>.
              If you are filling this out for your child, enter your child's name, date of birth, and other details.
            </p>
            <button
              onClick={() => setScreen(S.SECTION_A)}
