...
const READY_SPEECH =
  'Your Simplified Adult Renewal form is ready! Please look it over carefully before you print. ' +
  'Remember to bring your current passport, two recent passport-size photos, and your payment receipt to the PICA office. ' +
  'You are almost there — good luck!'

const WHAT_TO_BRING = [
  { text: 'Completed application form (this one)',               always: true  },
  { text: 'Current passport (the one being renewed)',            always: true  },
  { text: 'Two recent passport-size photos',                     always: true  },
  { text: 'Proof of payment of the renewal fee',                 always: true  },
  { text: 'Marriage certificate (if your name changed)',         always: false },
  { text: 'Deed poll (if you changed your name by deed poll)',   always: false },
]
...
export default function SimplifiedRenewalFormReadyScreen({ pdfUrl, onBack, onViewHistory, onStartAnother, onHome }) {
  ...
  const handleDownload = () => {
    ...
    a.href = pdfUrl
    a.download = 'Simplified-Renewal-Application-Completed.pdf'
    a.click()
  }
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col px-5 pt-8 pb-10 overflow-y-auto">
        ...
        <p className="text-gray-500 text-sm text-center leading-relaxed mb-6 px-2">
          Great job. Your Simplified Adult Renewal form has been completed and is ready to download, print, or review.
        </p>
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: '#92400e' }}>
            Sign the declaration section in front of the PICA officer. Keep your signature inside the border. Your thumbprint will be taken at the office.
          </p>
        </div>
