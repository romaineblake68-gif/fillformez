...
const COMPLETE_MSG =
  'You have completed the fourth section! You are doing great. Just a few more to go.'
...
export default function SectionDCompleteScreen({ onContinue }) {
    ...
    <div className="flex flex-col min-h-screen bg-white overflow-hidden relative">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-10">
        ...
        <p className="text-gray-500 text-lg text-center leading-relaxed mb-10 px-2">
          <strong className="text-black">Just a few more to go!</strong>
        </p>
        ...
        >
          ...
          <div>
            <p className="text-black font-bold text-sm">Section D — Most Recent Passport</p>
