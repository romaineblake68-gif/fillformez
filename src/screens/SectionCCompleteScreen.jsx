...
const COMPLETE_MSG =
  'You have completed the third section! Almost halfway there. You are doing a great job.'
...
export default function SectionCCompleteScreen({ onContinue }) {
    ...
    <div className="flex flex-col min-h-screen bg-white overflow-hidden relative">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-10">
        ...
        <p className="text-gray-500 text-lg text-center leading-relaxed mb-10 px-2">
          You are doing a <strong className="text-black">great job!</strong>
        </p>
        ...
        >
          ...
          <div>
            <p className="text-black font-bold text-sm">Section C — Parental Consent</p>
            <p className="text-gray-400 text-xs mt-0.5">All questions answered ✓</p>
          </div>
        </div>
