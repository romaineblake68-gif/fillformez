...
const READY_SPEECH =
  'Your N I S registration form is ready! Please look it over carefully before you print. Then bring it to your nearest National Insurance Scheme office with your identification and the completed form. You are almost there — good luck!'

const WHAT_TO_BRING = [
  'Completed NIS registration form (this one)',
  'Valid photo ID (passport, driver\'s licence, or national ID)',
  'Birth certificate',
  'TRN number (if you have one)',
]
...
export default function NISFormReadyScreen({ pdfUrl, onBack }) {
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col px-5 pt-8 pb-10 overflow-y-auto">
        ...
        >
          ...
          Download My NIS Registration Form
        </button>
        ...
        >
          <p className="text-black font-bold text-sm mb-4">What to bring to the NIS office</p>
