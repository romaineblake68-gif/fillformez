...
const COMPLETE_MSG =
  'You have completed the second section! You are making great progress. Keep going.'
...
export default function SectionBCompleteScreen({ onContinue }) {
    ...
    <div className="flex flex-col min-h-screen bg-white overflow-hidden relative">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-10">
        ...
        <p className="text-gray-500 text-lg text-center leading-relaxed mb-10 px-2">
          <strong className="text-black">Keep going!</strong>
        </p>
        ...
        >
          ...
          <div>
            <p className="text-black font-bold text-sm">Section B — Marriage Information</p>
            <p className="text-gray-400 text-xs mt-0.5">All 4 questions answered ✓</p>
          </div>
        </div>
