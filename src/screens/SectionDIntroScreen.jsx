...
const INTRO_MSG =
  "This next section is about your most recent passport. Have your old passport ready if you can — it will make this easier. If your passport is lost or stolen, do not worry, I will guide you through that too."
...
export default function SectionDIntroScreen({ onContinue, onBack }) {
      ...
      <div className="flex-1 flex flex-col px-5 pt-8 pb-8 overflow-y-auto">
        ...
        <div className="flex justify-center mb-6">
          ...
          >
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
              <rect x="3" y="2" width="18" height="20" rx="3" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <rect x="7" y="7" width="10" height="1.5" rx="0.75" fill="#7c3aed" />
              <rect x="7" y="10.5" width="7" height="1.5" rx="0.75" fill="#7c3aed" opacity="0.6" />
              <rect x="7" y="14" width="8" height="1.5" rx="0.75" fill="#7c3aed" opacity="0.6" />
            </svg>
          </div>
        </div>
        ...
        >
          <p className="text-gray-800 text-base leading-relaxed mb-3">
            This section asks about the <strong className="text-black">passport you had before</strong>.
          </p>
          <p className="text-gray-600 text-sm leading-relaxed">
            Have your old passport ready if you can — it will make this easier. If your passport is <strong className="text-black">lost or stolen</strong>, do not worry — I will guide you through that too.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          {[
            ...
            'Your passport number and issue date',
            'The name on the old passport',
          ].map((item) => (
