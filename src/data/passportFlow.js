...
export const SECTION_A_QUESTIONS = {
  ...
  placeOfBirth: {
    ...
    section: 'Section A — Personal Information',
    base: 8,
    text: 'What parish were you born in?',
    hint: 'PICA accepts the parish for place of birth. Say or type the parish, for example Kingston, St. Andrew, or St. Elizabeth.',
    isParish: true,
    type: 'voice',
    next: () => 'birthDay',
  },
