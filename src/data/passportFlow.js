...
export const SECTION_A_QUESTIONS = {
  ...
  placeOfBirth: {
    ...
    section: 'Section A — Personal Information',
    base: 8,
    text: 'What parish were you born in? If you were born overseas, write the state or country.',
    hint: 'PICA accepts the parish for place of birth. Say or type the parish — for example Kingston or St. Elizabeth. If you were born overseas, say the state or country instead.',
    isParish: true,
    type: 'voice',
    next: () => 'birthDay',
  },
...
export const SECTION_C_QUESTIONS = {
  ...
  guardianSurname: {
    ...
    base: 1,
    text: "What is the parent or guardian's surname?",
    hint: "This is YOUR surname as the parent or legal guardian — not the child's surname.",
    type: 'voice',
  ...
  guardianFirstName: {
    ...
    section: 'Section C — Parental Consent',
    base: 2,
    text: "What is the parent or guardian's first name?",
    hint: 'This is YOUR first name as the parent or legal guardian completing this section.',
    type: 'voice',
  ...
  guardianHasMiddleName: {
    ...
    section: 'Section C — Parental Consent',
    base: 3,
    text: 'Does the parent or guardian have a middle name?',
  ...
  guardianMiddleName: {
    ...
    base: 3,
    isSubQ: true,
    text: "What is the parent or guardian's middle name?",
    hint: 'Say the middle name clearly, one word at a time.',
    type: 'voice',
    next: () => 'relationship',
  },
